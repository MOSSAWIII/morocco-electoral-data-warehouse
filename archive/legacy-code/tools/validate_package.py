...
from morocco_elections.warehouse.package import package_context, validate_package  # noqa: E402
from morocco_elections.warehouse.publication import validate_publication  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate a warehouse package only from its package root")
