...
def get_paths(data_dir: str | Path | None = None) -> ProjectPaths:
    ...
    return ProjectPaths(
        ...
        parliament_questions_2023_sources=tuple(
            data_root / "raw" / "parliament" / "questions" / "written" / "2023" / name
            for name in (
        ...
        v11_smiig_decision_report=PROJECT_ROOT / "docs" / "research" / "V11_SMIIG_QUALIFICATION.txt",
    )
