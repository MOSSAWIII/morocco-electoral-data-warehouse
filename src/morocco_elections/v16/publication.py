...
from morocco_elections.v16.coverage import DIMENSIONS, coverage_report, validate_universes
from morocco_elections.v16.contracts import TABLE_CONTRACTS
from morocco_elections.v16.demography import load_hcp_rgph2014_individuals, validate_population_crosswalks
from morocco_elections.v16.history import (
    geographies_comparable,
    validate_geo_history,
    validate_party_history,
    validate_result_geographies,
)
from morocco_elections.v16.institutional import validate_candidacies_and_seats
from morocco_elections.v16.immutability import (
    CANONICAL_MANIFEST_BYTES,
    CANONICAL_MANIFEST_SHA256,
    MANIFEST_PATH,
    verify_v15_immutability,
)
from morocco_elections.v16.reconciliation import compare
from morocco_elections.v16.schema import OPTIONAL_FIELDS
from morocco_elections.v16.validation import (
    ValidationIssue,
    _as_date,
...
def _semantic_facts(context: PublicationContext) -> GateResult:
    ...
    from morocco_elections.v16.geo_parents import validate_geo_parent_relations
...
def _official_universe(context: PublicationContext) -> GateResult:
    ...
    if portability:
        from morocco_elections.v16.portability import SourceEvidenceError, portable_evidence_root
    ...
    for row in universes:
        ...
        try:
            if method == "HCP_RGPH2014_COMMUNES" and source_id == "MA_HCP_RGPH2014_POPULATION_LEGALE_COMMUNES_12_REGIONS":
                from morocco_elections.v16.demography import load_hcp_rgph2014_territorial_universe
...
def _reproducible(context: PublicationContext) -> GateResult:
    ...
    for row in rows:
        ...
        for required_command in ("tests", "validate_v16"):
