...
def validate_ontology(ontology: dict) -> list[str]:
    errors: list[str] = []
    if ontology.get("schema_version") != 1 or ontology.get("ontology_version") != "1.2.0":
        errors.append("version de l'ontologie invalide")
    if ontology.get("baseline_release") != "V14":
        errors.append("la baseline de l'ontologie doit être V14")
