...
VOCABULARIES = {
    ...
    for item in (
        ...
        _v("universe_type", OFFICIAL_CONTESTS="Official contests", OFFICIAL_TERRITORIES="Official territories", OFFICIAL_SEAT_ALLOCATIONS="Official party seat allocations", OFFICIAL_RECORDS="Official records", OFFICIAL_DOCUMENTS="Official documents", OFFICIAL_FIELDS="Expected official fields", OFFICIAL_PERIODS="Official temporal periods"),
        _v("member_extraction_method", HCP_RGPH2014_COMMUNES="Reparse all complete HCP RGPH 2014 communal and arrondissement codes, including suppressed-population rows", CHAMBER_2021_NATIONAL_SEATS="Reparse the official House table of national party seat allocations", JSON_UNIVERSES_OBJECT="Reparse an official JSON universes object with explicit identifiers by universe ID"),
