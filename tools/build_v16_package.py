...
from morocco_elections.v16.package import build_package, package_context  # noqa: E402
from morocco_elections.v16.publication import sha256_file, validate_publication  # noqa: E402
from morocco_elections.v16.readiness import build_readiness_context  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the closed, package-rooted V16 development package")
    parser.add_argument("--seed", type=Path, default=ROOT / "data/exports/open/v15/morocco_elections_v15.duckdb")
    parser.add_argument("--package-root", type=Path, default=ROOT / "data/exports/open/v16-development")
    ...
    parser.add_argument(
        ...
        default=ROOT / "data/exports/open/v16-development-build-report.json",
        help="internal, explicitly non-packaged build report",
    )
    parser.add_argument(
        "--gate-report", type=Path,
        default=ROOT / "data/exports/open/v16-development-gate-report.json",
        help="internal, explicitly non-packaged gate-scope report",
    )
    parser.add_argument(
        "--portability-report", type=Path,
        default=ROOT / "data/exports/open/v16-development-portability-report.json",
    ...
    context, _ = build_readiness_context(
        package_root / "morocco_elections_v16.duckdb", ROOT, files=manifest["files"],
