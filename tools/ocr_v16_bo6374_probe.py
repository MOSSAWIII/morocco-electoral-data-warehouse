...
DEFAULT_SOURCE = Path("data/raw/elections/v16/legal/bo_6374_ar_decree_2_15_402_communes_2015.pdf")
...
async def recognize_page(source: Path, page_index: int, scale: float) -> dict:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="v16_bo6374_ocr_") as temporary:
