...
-- 3. Résultats d'un territoire (remplacer l'identifiant).
...
-- 4. Résultats d'un parti (remplacer l'identifiant).
...
-- 5. Sièges disponibles; les absences restent visibles.
...
-- 6. Participation disponible et dénominateur utilisé.
...
-- 11. Contrôles de rapprochement, y compris NOT_COMPUTABLE.
...
-- 12. Provenance d'une valeur de résultat.
...
-- 13. Licences applicables.
SELECT source_id, source_name, publisher, license, status, url
FROM analytics_provenance
ORDER BY source_id;

-- 14. Les 177 identifiants internes non reliés à l'univers HCP.
...
-- 15. Allocation nationale officielle des sièges en 2021, séparée des faits observés.
