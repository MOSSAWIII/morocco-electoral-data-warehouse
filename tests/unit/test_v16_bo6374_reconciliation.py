...
from morocco_elections.v16.bo6374_reconciliation import build_reconciliation, validate_reconciliation
...
def test_bo_tafra_reconciliation_is_complete_bijective_and_fail_closed() -> None:
    ...
    assert report["unmatched_with_verified_v16_parent"] == 4
    ...
    assert {row["v16_communal_parent_id"] for row in unmatched} == {
