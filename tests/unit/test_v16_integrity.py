...
from morocco_elections.v16.contracts import TABLE_CONTRACTS, VOCABULARIES
from morocco_elections.v16.build import build_development_database
from morocco_elections.v16.coverage import DIMENSIONS, UNKNOWN, coverage_report, validate_universes
from morocco_elections.v16.history import validate_result_geographies
from morocco_elections.v16.immutability import load_manifest, verify_v15_immutability, verify_v15_publication_asset
from morocco_elections.v16.schema import create_schema, schema_inventory
from morocco_elections.v16.validation import V16ValidationError, validate_or_raise, validate_rows, validate_semantic_consistency
from morocco_elections.v16.versions import applicable_revision, validate_revisions
...
def test_v16_build_is_additive_and_refuses_overwrite(tmp_path: Path) -> None:
    import duckdb
    ...
    assert report["created_v16_tables"] == len(TABLE_CONTRACTS)
...
def test_errors_are_raiseable_and_vocabulary_is_closed() -> None:
    ...
    except V16ValidationError as exc:
