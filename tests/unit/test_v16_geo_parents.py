...
from morocco_elections.v16.geo_parents import (
    _verify_manifest_sources,
    build_geo_parent_evidence,
    derive_comm2015_parent_relations,
    validate_geo_parent_relations,
)
from morocco_elections.v16.validation import validate_semantic_consistency
...
def test_comm2015_seed_rejects_deleted_or_invented_arrondissement(evidence) -> None:
    ...
    seed = json.loads((ROOT / "metadata/v16/comm2015_geo_parents.seed.json").read_text(encoding="utf-8"))
